...
class %CLASS%(NodeInstance):
    ...
    def update_event(self, input_called=-1):
        ...
        if self.input(0): d["attributes"].append({"name": "ExternalNetDeviceId", "value": self.input(0)})
        if self.input(1): d["attributes"].append({"name": "InternalNetDeviceId", "value": self.input(1)})
